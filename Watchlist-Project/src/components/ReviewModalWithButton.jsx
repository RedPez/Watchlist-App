  ...
  return (
    ...
    <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
          ...
          <div className='character-rating'> Characters: <RatingStarInput /></div> 
          <div className='plot-rating'>Plot/Content: <RatingStarInput /></div>
          <div className='writing-rating'>Writing: <RatingStarInput /></div>
          <div className='pace-rating'>Pace: <RatingStarInput /> </div> 
          <div className='review-txt'>Write your review here: </div>
          <div className='overall-rating'>Overall rating: <RatingStarInput /></div>
        </Modal.Body>
        <Modal.Footer>
